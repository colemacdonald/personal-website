...
RoomThemes[RoomBackgroundTheme.Outside] = {
  ...
  platformTiles: {
    ...
    rightSide: new Frame({
      src: require('../../../../../resources/wize/tiles/platforms/plat_vertical_tile_right.png')
    }),
    bottomLeft: new Frame({
      src: require('../../../../../resources/wize/tiles/platforms/plat_vertical_floating_tile_left.png')
    }),
    bottomRight: new Frame({
      src: require('../../../../../resources/wize/tiles/platforms/plat_vertical_floating_tile_right.png')
    }),
  ...
  doorFrame: new Frame({
    src: require('../../../../../resources/wize/doors/cave/door.png'),
    hitBoxes: [{ x: 30, y: 60, h: 40, w: 40 }]
  })
};
...
RoomThemes[RoomBackgroundTheme.Castle] = {
  ...
  backgroundMusic: require('../../../../../resources/wize/audio/Prelude in F  Minor (with Accompaniment).mp3'),
  doorFrame: new Frame({
    src: require('../../../../../resources/wize/doors/castle/door1.png'),
    hitBoxes: [{ x: 30, y: 60, h: 40, w: 40 }]
  })
};
...
RoomThemes[RoomBackgroundTheme.Cave] = {
  ...
  secondaryColour: '#472d3c',
  floorColour: 'black',
  horizontalBackgroundImage: new Frame({
    src: require('../../../../../resources/wize/backgrounds/cave/Bright/Background.png')
  }),
  verticalBackgroundImage: new Frame({
    src: require('../../../../../resources/wize/backgrounds/cave/Bright/Background-vertical.png')
  }),
  platformTiles: {
...
RoomThemes[RoomBackgroundTheme.Autumn] = {
  ...
  floorColour: 'brown',
  horizontalBackgroundImage: new Frame({
    src: require('../../../../../resources/wize/backgrounds/autumn/background.png')
  }),
  platformTiles: {

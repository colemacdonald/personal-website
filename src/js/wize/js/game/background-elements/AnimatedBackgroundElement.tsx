...
export class AnimatedBackgroundElement extends StationarySprite {
  constructor(options) {
    super({
      frames: AnimatedBackgroundElementFrames[options.type],
      x: options.x,
      y: options.y,
...
AnimatedBackgroundElementFrames[AnimatedBackgroundElementType.LavaDrop1_Top][State.Idle] = [
  new Frame({
    src: require('../../../../../resources/wize/background-elements/lava-drop/lava_drop1_1.png'),
    ticks: 20
  }),
  new Frame({
    src: require('../../../../../resources/wize/background-elements/lava-drop/lava_drop1_2.png'),
    ticks: 20
  }),
  new Frame({
    src: require('../../../../../resources/wize/background-elements/lava-drop/lava_drop1_3.png'),
    ticks: 20
  }),
...
AnimatedBackgroundElementFrames[AnimatedBackgroundElementType.LavaDrop1_Drop][State.Idle] = [
  ...
  new Frame({
    src: require('../../../../../resources/wize/background-elements/lava-drop/lava_drop1_5.png'),
    ticks: 20,
    y_offset: -100,
    x_offset: 48
  }),
  new Frame({
    src: require('../../../../../resources/wize/background-elements/lava-drop/lava_drop1_6.png'),
    ticks: 20,
    x_offset: 33
  }),
  new Frame({
    src: require('../../../../../resources/wize/background-elements/lava-drop/lava_drop1_7.png'),
    ticks: 20,
    x_offset: 33
  }),
  new Frame({
    src: require('../../../../../resources/wize/background-elements/lava-drop/lava_drop1_8.png'),
    ticks: 20,
    x_offset: 33
  }),
  new Frame({
    src: require('../../../../../resources/wize/background-elements/lava-drop/lava_drop1_9.png'),
    ticks: 20,
    x_offset: 33
  })
];

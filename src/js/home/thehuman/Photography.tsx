...
export const Photography = () => (
  <ContentPage classes="photography">
    ...
    <p>
      This is a small collection of the photos I have taken over the years. The majority of them were shot on iPhone but
      some of them were taken with a GoPro. Hope you enjoy!
    </p>
    <Carousel fade={true}>
      {' '}
      {images.map((i) => (
